...
import me.friedhof.chess.networking.packet.ChangeNotationVisibilityC2SPacket;
...
public class ModMessages {
    ...
    public static final Identifier CHANGE_NOTATION_VISIBILITY = new Identifier(Chess.MOD_ID,"change_notation_visibility");


    public static void registerC2SPackets(){

        ServerPlayNetworking.registerGlobalReceiver(SPAWN_FIGURE, SpawnFigureC2SPacket::receive);
        ServerPlayNetworking.registerGlobalReceiver(CHANGE_NOTATION_VISIBILITY, ChangeNotationVisibilityC2SPacket::receive);
    }
