...
public class BlackTowerItem extends Item {


    public BlackTowerItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if(w.isClient()) {
            ...
            buffer.writeIntArray(new int[]{pos.getX(), pos.getY(), pos.getZ(), d.getId(),5,rotation});
