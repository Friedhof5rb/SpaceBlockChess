...
public class CastleBlackTowerItem extends Item {


    public CastleBlackTowerItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if(w.isClient()) {
            ...
            buffer.writeIntArray(new int[]{pos.getX(), pos.getY(), pos.getZ(), d.getId(),15,rotation});
