...
public class StartBlackPawnItem extends Item {
    public StartBlackPawnItem(Settings settings) {
        super(settings);
    }
    @Override
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if(w.isClient()) {
            ...
            buffer.writeIntArray(new int[]{pos.getX(), pos.getY(), pos.getZ(), d.getId(),13,rotation});
