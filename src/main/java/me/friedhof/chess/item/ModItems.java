...
public class ModItems {
    ...
    //Utility
    public static final Item ROD_OF_REMOVAL = registerItem("rod_of_removal",new Item(new FabricItemSettings().maxCount(1)));
    public static final Item ROD_OF_ROTATION = registerItem("rod_of_rotation",new Item(new FabricItemSettings().maxCount(1)));
    public static final Item MOVE_HIGHLIGHTER = registerItem("move_highlighter",new Item(new FabricItemSettings()));

    public static final Item CHESS_CORE = registerItem("chess_core",new Item(new FabricItemSettings()));
    public static final Item CHESS_POS1 = registerItem("chesspos1",new ChessPos1Item(new FabricItemSettings()));
    public static final Item CHESS_POS2 = registerItem("chesspos2",new ChessPos2Item(new FabricItemSettings()));

    public static final Item WHITE_ROD_OF_MOVING = registerItem("white_rod_of_moving",new Item(new FabricItemSettings().maxCount(1)));
    public static final Item BLACK_ROD_OF_MOVING = registerItem("black_rod_of_moving",new Item(new FabricItemSettings().maxCount(1)));
    ...
    public static final Item WHITE_TORCH = registerItem("white_torch",new Item(new FabricItemSettings().maxCount(1)));
    public static final Item BLACK_TORCH= registerItem("black_torch",new Item(new FabricItemSettings().maxCount(1)));

    public static final Item YELLOW_TORCH= registerItem("yellow_torch",new Item(new FabricItemSettings().maxCount(1)));
    public static final Item PINK_TORCH= registerItem("pink_torch",new Item(new FabricItemSettings().maxCount(1)));



    //White
    public static final Item WHITE_PAWN = registerItem("white_pawn",new WhitePawnItem(new FabricItemSettings().maxCount(64)));
    public static final Item WHITE_TOWER = registerItem("white_tower",new WhiteTowerItem(new FabricItemSettings().maxCount(64)));
    public static final Item WHITE_KNIGHT = registerItem("white_knight",new WhiteKnightItem(new FabricItemSettings().maxCount(64)));
    public static final Item WHITE_BISHOP = registerItem("white_bishop",new WhiteBishopItem(new FabricItemSettings().maxCount(64)));
    public static final Item WHITE_QUEEN = registerItem("white_queen",new WhiteQueenItem(new FabricItemSettings().maxCount(64)));
    public static final Item WHITE_KING= registerItem("white_king",new WhiteKingItem(new FabricItemSettings().maxCount(64)));

    public static final Item START_WHITE_PAWN = registerItem("start_white_pawn",new StartWhitePawnItem(new FabricItemSettings().maxCount(64)));
    public static final Item CASTLE_WHITE_KING = registerItem("castle_white_king",new CastleWhiteKingItem(new FabricItemSettings().maxCount(64)));
    public static final Item CASTLE_WHITE_TOWER = registerItem("castle_white_tower",new CastleWhiteTowerItem(new FabricItemSettings().maxCount(64)));
    ...
    //Black
    public static final Item BLACK_PAWN = registerItem("black_pawn",new BlackPawnItem(new FabricItemSettings().maxCount(64)));
    public static final Item BLACK_TOWER = registerItem("black_tower",new BlackTowerItem(new FabricItemSettings().maxCount(64)));
    public static final Item BLACK_KNIGHT = registerItem("black_knight",new BlackKnightItem(new FabricItemSettings().maxCount(64)));
    public static final Item BLACK_BISHOP = registerItem("black_bishop",new BlackBishopItem(new FabricItemSettings().maxCount(64)));
    public static final Item BLACK_QUEEN = registerItem("black_queen",new BlackQueenItem(new FabricItemSettings().maxCount(64)));
    public static final Item BLACK_KING= registerItem("black_king",new BlackKingItem(new FabricItemSettings().maxCount(64)));



    public static final Item START_BLACK_PAWN = registerItem("start_black_pawn",new StartBlackPawnItem(new FabricItemSettings().maxCount(64)));
    public static final Item CASTLE_BLACK_KING = registerItem("castle_black_king",new CastleBlackKingItem(new FabricItemSettings().maxCount(64)));
    public static final Item CASTLE_BLACK_TOWER = registerItem("castle_black_tower",new CastleBlackTowerItem(new FabricItemSettings().maxCount(64)));
    ...
    //Yellow
    public static final Item YELLOW_PAWN = registerItem("yellow_pawn",new YellowPawnItem(new FabricItemSettings().maxCount(64)));
    public static final Item YELLOW_TOWER = registerItem("yellow_tower",new YellowTowerItem(new FabricItemSettings().maxCount(64)));
    public static final Item YELLOW_KNIGHT = registerItem("yellow_knight",new YellowKnightItem(new FabricItemSettings().maxCount(64)));
    public static final Item YELLOW_BISHOP = registerItem("yellow_bishop",new YellowBishopItem(new FabricItemSettings().maxCount(64)));
    public static final Item YELLOW_QUEEN = registerItem("yellow_queen",new YellowQueenItem(new FabricItemSettings().maxCount(64)));
    public static final Item YELLOW_KING= registerItem("yellow_king",new YellowKingItem(new FabricItemSettings().maxCount(64)));



    public static final Item START_YELLOW_PAWN = registerItem("start_yellow_pawn",new StartYellowPawnItem(new FabricItemSettings().maxCount(64)));
    public static final Item CASTLE_YELLOW_KING = registerItem("castle_yellow_king",new CastleYellowKingItem(new FabricItemSettings().maxCount(64)));
    public static final Item CASTLE_YELLOW_TOWER = registerItem("castle_yellow_tower",new CastleYellowTowerItem(new FabricItemSettings().maxCount(64)));
    ...
    //pink
    public static final Item PINK_PAWN = registerItem("pink_pawn",new PinkPawnItem(new FabricItemSettings().maxCount(64)));
    public static final Item PINK_TOWER = registerItem("pink_tower",new PinkTowerItem(new FabricItemSettings().maxCount(64)));
    public static final Item PINK_KNIGHT = registerItem("pink_knight",new PinkKnightItem(new FabricItemSettings().maxCount(64)));
    public static final Item PINK_BISHOP = registerItem("pink_bishop",new PinkBishopItem(new FabricItemSettings().maxCount(64)));
    public static final Item PINK_QUEEN = registerItem("pink_queen",new PinkQueenItem(new FabricItemSettings().maxCount(64)));
    public static final Item PINK_KING= registerItem("pink_king",new PinkKingItem(new FabricItemSettings().maxCount(64)));




    public static final Item START_PINK_PAWN = registerItem("start_pink_pawn",new StartPinkPawnItem(new FabricItemSettings().maxCount(64)));
    public static final Item CASTLE_PINK_KING = registerItem("castle_pink_king",new CastlePinkKingItem(new FabricItemSettings().maxCount(64)));
    public static final Item CASTLE_PINK_TOWER = registerItem("castle_pink_tower",new CastlePinkTowerItem(new FabricItemSettings().maxCount(64)));
    ...
    private static Item registerItem(String name, Item item){
        return Registry.register(Registries.ITEM,new Identifier(Chess.MOD_ID,name),item);
    }
